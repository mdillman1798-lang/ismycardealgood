  ...
  return (
    <div className="section">
      <div className="container max-w-3xl">
        ...
        <h1 className="text-3xl sm:text-4xl font-bold text-zinc-900 mb-4">About Us</h1>
        ...
        <div className="space-y-10">
          <section>
            <h2 className="text-xl font-semibold text-zinc-900 mb-3">The problem we're solving</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-zinc-900 mb-3">What we believe</h2>
              ...
              {[
                ...
                <div key={String(title)} className="flex gap-4">
                  <div className="mt-1 w-5 h-5 rounded-full bg-brand-100 flex items-center justify-center shrink-0">
                    <svg className="w-3 h-3 text-brand-600" fill="none" stroke="currentColor" strokeWidth={2.5} viewBox="0 0 24 24">
          ...
          <section>
            <h2 className="text-xl font-semibold text-zinc-900 mb-3">The tools</h2>
            <div className="grid sm:grid-cols-3 gap-4">
              {[
                ...
                <Link
                  key={t.href}
                  href={t.href}
                  className="block p-4 rounded-xl border border-zinc-200 hover:border-brand-200 hover:shadow-sm transition-all group"
                >
                  <p className="text-sm font-semibold text-zinc-900 group-hover:text-brand-600 transition-colors mb-1">{t.label}</p>
